...
const re_aligner = () => {
    ...
    if (marker_group.length > 0) {
        marker_group.forEach(ele => {
            ...
            // console.log(`The left - ${ele.style.left}`);
            // console.log(`The offsetleft - ${ele.offsetLeft}`);
            // console.log(`The clientleft - ${ele.clientLeft}`);
            // console.log(`The width - ${ele.style.width}`);
            // console.log(`The offsetWidth - ${ele.offsetWidth}`);
            // console.log(`The clientWidth - ${ele.clientWidth}`);
        });
    }
};
